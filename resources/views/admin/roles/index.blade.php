                    ...
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-2 border">
                            <div class="flex space-x-2">
                                @if($role->is_super)
                                    <button class="bg-blue-300 text-white px-4 py-2 rounded cursor-not-allowed" disabled>
                                        Edit
                                    </button>
                                    <button class="bg-red-300 text-white px-4 py-2 rounded cursor-not-allowed" disabled>
                                        Delete
                                    </button>
                                @else
...
<script>
    function openDeleteModal(roleId, roleName) {
        document.getElementById('role-name').innerText = 'Role: ' + roleName;
        document.getElementById('delete-form').setAttribute('action', '/admin/roles/' + roleId);
